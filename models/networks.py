...
def define_G(netG, **kwargs):
    ...
    if netG in ['resnet_9blocks', 'mobile_resnet_9blocks', 'super_mobile_resnet_9blocks', 'super_mobile_resnet_9blocks_SPM_bi']:
