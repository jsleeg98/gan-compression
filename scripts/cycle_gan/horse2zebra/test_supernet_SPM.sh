...
python test_SPM.py --dataroot database/horse2zebra/valA \
  ...
  --restore_G_path logs/cycle_gan/horse2zebra/cyclegan_bi_level_MiniTest/supernet_macs_pm10_FDRU_YYYY_tr_0.5_mac_0.5_nuc_0.001_biStart_1_biInterval_2_Rmax_14/checkpoints/latest_net_G.pth \
  --need_profile \
